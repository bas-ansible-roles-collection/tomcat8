...
Installs and configures Apache Tomcat Java servlet container 8
 
**Part of the BAS Ansible Role Collection (BARC)**
 
**This role uses version 0.2.0 of the https://github.com/bas-ansible-roles-collection/tomcat8.git flavour of the BAS Base Project - Pristine**.
